...
class DBoperations:
    ...
    def createTables(self,dbName: str) -> None:
        ...
        sqlFile = '/home/natty/TellCo-Data-Analysis/schema.sql'
        fd = open(sqlFile, 'r')
        readSqlFile = fd.read()
        fd.close()
...
class dashbrd:
    def loadData(self):
            ...
            df =DBoperations.db_execute_fetch(self,query, dbName="test", rdf=True)
            return df  
...
if __name__ == "__main__":
    ...
    image = Image.open('/home/natty/Pictures/Screenshot from 2021-07-17 22-04-57.png')
